    ...
    <section className="about section" id="about">
        ...
        <video src={AboutVideo} className="about__img" autoplay muted loop />
            ...
            <div className="about__data">
                ...
                I am a dedicated fourth-year student with a strong passion for expanding my knowledge in software development.
                 I thrive on creating innovative solutions for app and website development and am always eager to learn and contribute within a collaborative environment.
