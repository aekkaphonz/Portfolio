...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Aekkaphon
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        I am a passionate and dedicated fourth-year student, 
        deeply committed to advancing my knowledge and expertise in software development.
            </p>
